...
void TSL_IO_Init(void)
{
  ...
  /* Enable RI Switch */
 // RI->ASCR1 &= (uint32_t)(~0x80000000); // ADC analog switches open !!!    milind changes

#ifdef PORT_A
  GPIOA->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_A | P1_IO_MASK_A));  /* Output push pull config */
  GPIOA->PUPDR &= (uint32_t)(~(P1_MODER_MASK_A | SAMP_CAP_MODER_MASK_A));
#endif
#ifdef PORT_B
  GPIOB->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_B | P1_IO_MASK_B));  /* Output push pull config */
  GPIOB->PUPDR &= (uint32_t)(~(P1_MODER_MASK_B | SAMP_CAP_MODER_MASK_B));
#endif
#ifdef PORT_C
  GPIOC->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_C | P1_IO_MASK_C));  /* Output push pull config */
  GPIOC->PUPDR &= (uint32_t)(~(P1_MODER_MASK_C | SAMP_CAP_MODER_MASK_C));
#endif

#if (NUMBER_OF_SINGLE_CHANNEL_PORTS > 1)
#ifdef PORT_A
  GPIOA->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_A | P2_IO_MASK_A));  /* Output push pull config */
  GPIOA->PUPDR &= (uint32_t)(~(P2_MODER_MASK_A | SAMP_CAP_MODER_MASK_A));
#endif
#ifdef PORT_B
  GPIOB->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_B | P2_IO_MASK_B));  /* Output push pull config */
  GPIOB->PUPDR &= (uint32_t)(~(P2_MODER_MASK_B | SAMP_CAP_MODER_MASK_B));
#endif
#ifdef PORT_C
  GPIOC->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_C | P2_IO_MASK_C));  /* Output push pull config */
  GPIOC->PUPDR &= (uint32_t)(~(P2_MODER_MASK_C | SAMP_CAP_MODER_MASK_C));
#endif
#endif

#if (NUMBER_OF_SINGLE_CHANNEL_PORTS > 2)
#ifdef PORT_A
  GPIOA->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_A | P3_IO_MASK_A));  /* Output push pull config */
  GPIOA->PUPDR &= (uint32_t)(~(P3_MODER_MASK_A | SAMP_CAP_MODER_MASK_A));
#endif
#ifdef PORT_B
  GPIOB->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_B | P3_IO_MASK_B));  /* Output push pull config */
  GPIOB->PUPDR &= (uint32_t)(~(P3_MODER_MASK_B | SAMP_CAP_MODER_MASK_B));
#endif
#ifdef PORT_C
  GPIOC->OTYPER &= (uint16_t)(~(SAMP_CAP_IO_MASK_C | P3_IO_MASK_C));  /* Output push pull config */
  GPIOC->PUPDR &= (uint32_t)(~(P3_MODER_MASK_C | SAMP_CAP_MODER_MASK_C));
#endif
#endif
